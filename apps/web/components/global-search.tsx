    ...
    <div ref={wrapperRef} className="relative w-full max-w-md" style={{ zIndex: 9999 }}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-md border border-input bg-background py-2 pl-10 pr-10 text-sm focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
        />
        {query && !isLoading && (
          <button
            onClick={() => {
      ...
      {showDropdown && (
        <div
          className="absolute top-full left-0 right-0 mt-2 max-h-96 overflow-y-auto rounded-lg border bg-card shadow-xl"
          style={{ zIndex: 99999 }}
        >
          {isLoading && !results && (
            ...
            <div>
              ...
              {results.products.map((product) => (
                ...
                >
                  ...
                  <div className="text-sm text-muted-foreground">{product.supplier} • {product.category}</div>
                </button>
              ))}
            </div>
          )}
            ...
            <div>
              ...
              {results.suppliers.map((supplier) => (
                ...
                >
                  ...
                  <div className="text-sm text-muted-foreground">{supplier.location || "Location not set"} • {supplier.productCount} products</div>
                </button>
              ))}
            </div>
          )}
            ...
            <div>
              ...
              {results.orders.map((order) => (
                ...
                >
                  ...
                  <div className="text-sm text-muted-foreground">{order.supplier} • {order.status}</div>
                </button>
              ))}
            </div>
          )}
